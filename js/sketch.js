...
function preload(){
  algorithm = new Permutation();
  op_bt = new Option(['Permutation'], 0);
  op_bt.button.mousePressed(run_pt);

  op_dp = new Option(['Memoization'], 0);
  op_dp.button.mousePressed(run_mem);
...
function draw() {
   ...
   fill(color(255, 24, 100, 100));
    rect(width/2, height/2-50, width, 70);
